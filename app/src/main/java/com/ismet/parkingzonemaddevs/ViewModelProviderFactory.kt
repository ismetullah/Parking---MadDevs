...
import com.ismet.parkingzonemaddevs.ui.park.ParkViewHolder
...
constructor(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        ...
        } else if (modelClass.isAssignableFrom(ParkViewHolder::class.java)) {
            return ParkViewHolder(dataManager, schedulerProvider) as T
